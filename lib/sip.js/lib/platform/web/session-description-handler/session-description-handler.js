...
export class SessionDescriptionHandler {
    ...
    constructor(logger, mediaStreamFactory, sessionDescriptionHandlerConfiguration) {
        ...
        //we need to create a MediaStream from the MediaStreamFactory
        let MediaStream = wrtc.MediaStream;
        this._localMediaStream = new MediaStream();
        this._remoteMediaStream = new MediaStream();
        this._peerConnection = new wrtc.RTCPeerConnection(sessionDescriptionHandlerConfiguration === null || sessionDescriptionHandlerConfiguration === void 0 ? void 0 : sessionDescriptionHandlerConfiguration.peerConnectionConfiguration);
